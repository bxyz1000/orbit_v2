...
extension PlannerEventQueryWhere
  ...
  QueryBuilder<PlannerEvent, PlannerEvent, QAfterWhereClause> idLessThan(
    Id id, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
...
extension PlannerEventQueryFilter
  ...
  QueryBuilder<PlannerEvent, PlannerEvent, QAfterFilterCondition> dateEqualTo(
    DateTime value,
  ) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
  ...
  QueryBuilder<PlannerEvent, PlannerEvent, QAfterFilterCondition> dateLessThan(
    DateTime value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<PlannerEvent, PlannerEvent, QAfterFilterCondition> dateBetween(
    DateTime lower,
    DateTime upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension PlannerEventQuerySortBy
  ...
  QueryBuilder<PlannerEvent, PlannerEvent, QAfterSortBy> sortByColorValue() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<PlannerEvent, PlannerEvent, QAfterSortBy> sortByDate() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'date', Sort.asc);
    });
  }

  QueryBuilder<PlannerEvent, PlannerEvent, QAfterSortBy> sortByDateDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'date', Sort.desc);
    });
  }

  QueryBuilder<PlannerEvent, PlannerEvent, QAfterSortBy> sortByDescription() {
    return QueryBuilder.apply(this, (query) {
...
extension PlannerEventQuerySortThenBy
  ...
  QueryBuilder<PlannerEvent, PlannerEvent, QAfterSortBy> thenByColorValue() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'colorValue', Sort.asc);
    });
  }
  ...
  QueryBuilder<PlannerEvent, PlannerEvent, QAfterSortBy> thenByDate() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'date', Sort.asc);
    });
  }

  QueryBuilder<PlannerEvent, PlannerEvent, QAfterSortBy> thenByDateDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'date', Sort.desc);
    });
  }

  QueryBuilder<PlannerEvent, PlannerEvent, QAfterSortBy> thenByDescription() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'description', Sort.asc);
    });
  }
...
extension PlannerEventQueryWhereDistinct
  ...
  QueryBuilder<PlannerEvent, PlannerEvent, QDistinct> distinctByColorValue() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'colorValue');
    });
  }

  QueryBuilder<PlannerEvent, PlannerEvent, QDistinct> distinctByDate() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'date');
    });
  }

  QueryBuilder<PlannerEvent, PlannerEvent, QDistinct> distinctByDescription({
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
...
extension PlannerEventQueryProperty
  ...
  QueryBuilder<PlannerEvent, int, QQueryOperations> colorValueProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'colorValue');
    });
  }

  QueryBuilder<PlannerEvent, DateTime, QQueryOperations> dateProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'date');
    });
  }

  QueryBuilder<PlannerEvent, String?, QQueryOperations> descriptionProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'description');
    });
  }

  QueryBuilder<PlannerEvent, String, QQueryOperations> endTimeProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<PlannerEvent, String, QQueryOperations> startTimeProperty() {
    return QueryBuilder.apply(this, (query) {
